...
DIFFGRAM_S3_EXPIRATION_OFFSET = int(os.getenv('DIFFGRAM_S3_EXPIRATION_OFFSET', '604800'))
DIFFGRAM_S3_MINIMUM_DAYS_VALID = int(os.getenv('DIFFGRAM_S3_MINIMUM_DAYS_VALID', '5'))
DIFFGRAM_S3_NEW_OFFSET_DAYS_VALID = int(os.getenv('DIFFGRAM_S3_NEW_OFFSET_DAYS_VALID', '7'))
...
PROCESS_NOT_CHECK_MEMERY = bool(os.getenv('PROCESS_NOT_CHECK_MEMERY', False))
...
print("PROCESS_NOT_CHECK_MEMERY", PROCESS_NOT_CHECK_MEMERY)
...
print("DIFFGRAM_S3_EXPIRATION_OFFSET", DIFFGRAM_S3_EXPIRATION_OFFSET)
